...
export const ACTION_TYPE_LABEL = {
    ...
    [ACTION_TYPE.SPLIT]: {label: $localize`:@@split:Split`, color: 'purple', link: 'split'},
    [ACTION_TYPE.REVERSE_SPLIT]: {label: $localize`:@@reverseSplit:Reverse Split`, color: 'gray', link: 'reverse-split'}
} as const;
